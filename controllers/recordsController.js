...
exports.updateManageRules = catchAsync(async (req, res) => {
...
exports.updateThresholdPoints = catchAsync(async (req, res) => {
...
exports.updateRuleForTask = catchAsync(async (req, res) => {
  const taskId = req.params.taskId;
  const ruleId = req.body.ruleId;
...
exports.updateSkippedRuleCategories = catchAsync(async (req, res) => {
  const taskId = req.params.taskId;
...
exports.getStudentTasks = catchAsync(async (req, res) => {
  const timezone = getIPLocationOfUser(req);
...
exports.getAutomaticDataWithMistakes = catchAsync(async (req, res) => {
...
exports.updateTaskName = catchAsync(async (req, res) => {
...
exports.getAutomaticData = catchAsync(async (req, res) => {
...
exports.markObsolete = catchAsync(async (req, res) => {
